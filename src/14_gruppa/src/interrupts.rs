...
const TIMER_FREQUENCY: u32 = 100; // timer interrupt frequency
static TICKS: AtomicU64 = AtomicU64::new(0);

pub fn init_pit(frequency: u32) {
    use x86_64::instructions::port::Port; // would like to use anothe approach to this
...
pub fn play_sound(frequency: u16) {
    ...
    let pit_freq: u32 = TIMER_FREQUENCY;
